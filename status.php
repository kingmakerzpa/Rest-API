...
if(isset($_POST['submit']))
{
    ...
    $INPUT=$_POST['decresponse'];
}

$orderid = explode ("|", $INPUT); 

$temp = ($orderid[0]);

$plainreq= "$MEID|$temp|||||||||||NA|NA";

 $encrypted_data = encrypt($plainreq,$KEY);
...
$new_data = [
  ...
  $wsUrl = "https://upitest.hdfcbank.com/upi/transactionStatusQuery";
